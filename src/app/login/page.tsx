          ...
          {step === 'verify' ? (
            ...
            <>
              ...
              <button
                ...
                className="w-full mt-4 flex items-center justify-center gap-3 py-3 rounded-lg border border-white/[0.08] bg-white/[0.03] hover:bg-white/[0.06] transition-colors text-sm font-medium text-[#ECEEF5]"
              >
